onload=function(){
    const snake=document.getElementById("snake");  // 蛇的身体整体，用来在吃到食物时增加身体
    const snakes=snake.getElementsByTagName("div");  // 蛇的身体组成的可变数组
    const food=document.getElementById("food");  // food对象，用来进行食物的坐标转换
    let direction=null;
    ...
    function updateSnake(head){
        ...
        // 由于蛇的尾部仅仅在视觉上跑到了头的前边，而HTML结构并没有
        // 因此需要将结构上的尾部也挪到前面
